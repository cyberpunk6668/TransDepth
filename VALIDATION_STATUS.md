...
| Manifest | 6000 条，SHA256 `0e9374741d79c4470e580728c53c5eb8f4d5214bd7139651eaeb66ecdfdad38b` |
| 划分 | R_train=4000、R_dev=500、R_select=250、R_confirm=250、R_hold=1000 |
| 分组证据 | 6000 个 recorder 对应 6000 个唯一完整场景指纹；train/valid 指纹交集为 0；按场景整组划分 |
...
| 可靠 patch | 四角色每图平均透明可靠 patch 约 33.8–45.3 |
...
| 代码检查 | Ruff 通过；33 个单元/真实资产测试通过；编辑器无错误 |
